...
class OostVlaanderenScraper(BaseScraper):
    source = "oost_vlaanderen"
    base_url = "https://oost-vlaanderen.be"
    listing_url = "https://oost-vlaanderen.be/vacatures-provincie-oost-vlaanderen/alle-vacatures.html"
    ...
    def is_job_detail_url(self, url: str) -> bool:
        ...
        if not path.startswith("/vacatures-provincie-oost-vlaanderen/alle-vacatures/"):
            return False
